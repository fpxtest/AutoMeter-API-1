<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="计划" align="center" prop="planname" width="120"/>
      <el-table-column label="批次" align="center" prop="batchname" width="200"/>
      <el-table-column label="用例数" align="center" prop="testcasenums" width="100"/>
      <el-table-column label="成功数" align="center" prop="passnums" width="100"/>
      <el-table-column label="失败数" align="center" prop="failnums" width="100"/>
      <el-table-column label="消耗时间" align="center" prop="costtimes" width="100"/>
