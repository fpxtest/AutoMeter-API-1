...
(
    ...
    `conditionname`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '条件名',
    `objectid`    bigint(20) unsigned  COMMENT '目标Id，计划，用例的id',
    `objectname`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '目标名',
    `objecttype`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '目标类型',
    `conditiontype`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '条件类型，前置，后置，其他',
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='条件表';
...
/*!40000 ALTER TABLE `testcondition`
    DISABLE KEYS */;
INSERT INTO `testcondition`
