...
(
    ...
    `conditiontype`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '前置，后置',
    `casetype`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '功能，性能',
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='api用例前后置条件运行报告表';
...
/*!40000 ALTER TABLE `apicases_condition_report`
    DISABLE KEYS */;
