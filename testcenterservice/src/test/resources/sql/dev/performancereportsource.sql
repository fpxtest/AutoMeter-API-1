...
(
    ...
    `source`       varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '解析文件目录',
    `status`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '待解析，已解析',
    `create_time` datetime DEFAULT NOW() COMMENT '创建时间',
    `lastmodify_time`    datetime DEFAULT NOW() COMMENT '上一次修改时间',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='性能报告路径表';
...
/*!40000 ALTER TABLE `performancereportsource`
    DISABLE KEYS */;
