...
(
    ...
    `apdex`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'apdex',
    `toleration`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'toleration',
    `frustration`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'frustration',
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='api用例性能apdex表';
...
/*!40000 ALTER TABLE `apicases_performanceapdex`
    DISABLE KEYS */;
INSERT INTO `apicases_performanceapdex`
