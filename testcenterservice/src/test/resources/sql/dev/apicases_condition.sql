...
(
    ...
    `casedeployunitname`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '用例所属发布单元',
    ...
    `deployunitname`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '包含调用接口的发布单元',
