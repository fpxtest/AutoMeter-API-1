...
(
    ...
    `testplanname`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '计划名',
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='api计划用例统计报告表';
...
/*!40000 ALTER TABLE `statics_planandcases`
    DISABLE KEYS */;
INSERT INTO `statics_planandcases`
