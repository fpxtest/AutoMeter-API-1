...
(
    ...
    `batchid`    bigint(20) unsigned  COMMENT '批次id',
    `result`    bigint(20) unsigned  COMMENT '条件执行结果，成功，失败',
    `resultdesc`    bigint(20) unsigned  COMMENT '结果详情',
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='条件结果表';
...
/*!40000 ALTER TABLE `condition_report`
    DISABLE KEYS */;
