...
(
    ...
    `planname`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '计划名',
    ...
    `variablesvalue`  varchar(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT '变量值',
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='变量值表';
