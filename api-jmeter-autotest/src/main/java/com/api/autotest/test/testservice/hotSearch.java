...
public class hotSearch extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext ctx) {
        ...
        try {
            ...
            String expectcid = core.getExpectValue("data.ke[0].cid");
            getLogger().info(Testcore.logplannameandcasename + "expectcode is:" + expectcid);
            ...
            jsonObject1.getJSONObject("cid");

            String actualcid = jsonObject1.getJSONObject("cid").toString();
            getLogger().info(Testcore.logplannameandcasename + "actualcode is:" + actualcid);
            // 完成期望值和实际值的比较代码，并且收集断言结果
            assertinfo = TestAssert.AssertEqual(actualcid, expectcid);
        } catch (Exception ex) {
