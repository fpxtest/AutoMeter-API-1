    ...
    private void configureTasks() {
        ...
        try {
            ...
            if (lock) {
                ...
                PerformanceDispatchScheduleTask.log.info("性能任务-获取待执行的性能用例数：。。。。。。。。" + dispatchAllList.size());
                int PerformanceJmeter = GetJmeterProcess("PerformanceJmeterProcess", "性能");
                ...
                PerformanceDispatchScheduleTask.log.info("性能任务-可以并行执行Jmeter性能测试的用例数：。。。。。。。。" + PerformanceDispatchList.size());
                ...
                for (Dispatch dispatch : PerformanceDispatchList) {
                    ...
                    PerformanceDispatchScheduleTask.log.info("性能任务-执行性能用例名 is......." + CaseName);
